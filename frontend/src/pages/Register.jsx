      ...
      <div className="relative z-10 bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl max-w-md w-full p-8 border border-white/20">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-1">
            Sign up as <span className="font-semibold text-blue-700">{selectedRole === "admin" ? "Admin" : "User"}</span>
          </p>
        </div>
          ...
          <div className="space-y-5">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Demo: {selectedRole === "admin" ? "admin" : "user"}
              </p>
            </div>
            ...
            <div className="bg-blue-50 rounded-lg p-3 text-center">
              <p className="text-xs text-blue-600">
                ℹ️ Demo: Use username "{selectedRole === "admin" ? "admin" : "user"}" and any password (min 8 chars)
              </p>
            </div>
            ...
            >
              {loading ? (
                ...
                `Sign Up as ${selectedRole === "admin" ? "Admin" : "User"}`
              )}
            </button>
          </div>
        </form>
